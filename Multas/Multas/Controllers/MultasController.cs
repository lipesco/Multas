...
namespace Multas_tC.Controllers
{
    public class MultasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Infraccao,LocalDaMulta,ValorMulta,DataDaMulta,AgenteFK,CondutorFK,ViaturaFK")] Models.Multas multas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Infraccao,LocalDaMulta,ValorMulta,DataDaMulta,AgenteFK,CondutorFK,ViaturaFK")] Models.Multas multas)
        {
            if (ModelState.IsValid)
            {
